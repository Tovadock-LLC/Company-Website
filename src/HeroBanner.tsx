...
const BasicSvgCircle: React.FC<BasicSvgCircleProps> = ({
  ...
  return (
    <div className="flex justify-center items-center w-full h-full bg-gray-900">
      ...
      */}
      <svg
        className="w-full h-full max-w-lg max-h-lg" // Adjust these Tailwind classes to size your SVG
...
export const HeroBanner: FC = () => {
  return (
    <div className="w-screen h-48 bg-amber-600">
      <HeroAnimation />
    </div>
  );
};
